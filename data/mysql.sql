...
CREATE TABLE `Editions` (
  ...
  `Replacement_Number` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `Editions_Attributes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `Editions_Attributes_Values`
--

DROP TABLE IF EXISTS `Editions_Attributes_Values`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `Items_Attributes_Values` (
  ...
  `Items_Attribute_Value` varchar(32768) NOT NULL,
