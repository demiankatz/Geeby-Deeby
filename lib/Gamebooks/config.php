...
// Base file path for gamebook site:
define('GAMEBOOKS_HOME', '/home/gamebooks');
...
define('GAMEBOOKS_DB_NAME', 'gamebooks');
define('GAMEBOOKS_DB_USER', 'dbuser');
define('GAMEBOOKS_DB_PASS', 'dbpass');
