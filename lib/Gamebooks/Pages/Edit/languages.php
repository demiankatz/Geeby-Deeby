...
/**
 * Handler for languages page.
 *
 * @param   UI  $interface      Current instance of user interface class.
 */
function languages($interface)
{
    // Load languages from database:
    $languages = new LanguageList();
    $languages->assign($interface);
    
    // Display page with appropriate Javascript:
    $interface->addJavascript('edit_languages.js');
    $interface->showPage('languages.tpl');
}
?>