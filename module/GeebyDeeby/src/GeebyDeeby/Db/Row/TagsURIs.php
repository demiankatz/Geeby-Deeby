 ...
 * @link     https://github.com/demiankatz/Geeby-Deeby Main Site
 */
class TagsURIs extends TableAwareGateway implements TagsUriEntityInterface
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct('Sequence_ID', 'Tags_URIs', $adapter);
    }
