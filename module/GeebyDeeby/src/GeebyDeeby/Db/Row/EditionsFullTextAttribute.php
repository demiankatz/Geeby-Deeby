...
class EditionsFullTextAttribute extends RowGateway implements EditionsFullTextAttributeEntityInterface
{
    ...
    {
        return $this->Editions_Full_Text_Attribute_Name;
    }
    ...
    {
        $this->Editions_Full_Text_Attribute_Name = $name;
        return $this;
    }
    ...
    {
        return $this->Editions_Full_Text_Attribute_RDF_Property;
    }
    ...
    {
        $this->Editions_Full_Text_Attribute_RDF_Property = $property;
        return $this;
    }
