 ...
 * @link     https://github.com/demiankatz/Geeby-Deeby Main Site
 */
class TagsAttribute extends RowGateway implements TagsAttributeEntityInterface
{
    /**
     * Constructor
     *
    ...
    {
        return $this->Tags_Attribute_Name;
    }
    ...
    {
        return $this->Tags_Attribute_RDF_Property;
    }
    ...
    {
        $this->Tags_Attribute_RDF_Property = $property;
        return $this;
    }
