...
/**
 * Row Definition for Items_Attributes
 *
 * PHP version 8
 *
 ...
 * @link     https://github.com/demiankatz/Geeby-Deeby Main Site
 */
class ItemsAttribute extends RowGateway implements ItemsAttributeEntityInterface
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct('Items_Attribute_ID', 'Items_Attributes', $adapter);
    }
    ...
    {
        return $this->Items_Attribute_Name;
    }
    ...
    {
        $this->Items_Attribute_Name = $name;
        return $this;
    }
    ...
    {
        return $this->Items_Attribute_RDF_Property;
    }
    ...
    {
        $this->Items_Attribute_RDF_Property = $property;
        return $this;
    }
