...
/**
 * Series relationship entity model.
 *
 * PHP version 8
 *
...
class SeriesRelationship extends AbstractEntity implements SeriesRelationshipEntityInterface
{
     ...
     * @var int
     */
    #[ORM\Column(name: 'Series_Relationship_ID', type: 'bigint', nullable: false, options: ['unsigned' => true])]
    #[ORM\Id]
     ...
     * @var string
     */
    #[ORM\Column(name: 'Series_Relationship_Name', type: 'string', length: 255, nullable: false)]
     ...
     * @var ?string
     */
    #[ORM\Column(name: 'Series_Relationship_RDF_Property', type: 'string', length: 255, nullable: true)]
     ...
     * @var ?string
     */
    #[ORM\Column(name: 'Series_Inverse_Relationship_Name', type: 'string', length: 255, nullable: true)]
     ...
     * @var ?string
     */
    #[ORM\Column(name: 'Series_Inverse_Relationship_RDF_Property', type: 'string', length: 255, nullable: true)]
