 ...
 * @link     https://vufind.org/wiki/development:plugins:database_gateways Wiki
 */
#[ORM\Table(name: 'Tags_Relationships')]
#[ORM\Entity]
#[ORM\EntityListeners([Feature\EntityManagerInjector::class])]
class TagsRelationship extends AbstractEntity implements TagsRelationshipEntityInterface
{
    /**
     * Unique ID.
     *
     * @var int
     */
    #[ORM\Column(name: 'Tags_Relationship_ID', type: 'bigint', nullable: false, options: ['unsigned' => true])]
    #[ORM\Id]
     ...
     * @var string
     */
    #[ORM\Column(name: 'Tags_Relationship_Name', type: 'string', length: 255, nullable: false)]
     ...
     * @var ?string
     */
    #[ORM\Column(name: 'Tags_Relationship_RDF_Property', type: 'string', length: 255, nullable: true)]
     ...
     * @var ?string
     */
    #[ORM\Column(name: 'Tags_Inverse_Relationship_Name', type: 'string', length: 255, nullable: true)]
     ...
     * @var ?string
     */
    #[ORM\Column(name: 'Tags_Inverse_Relationship_RDF_Property', type: 'string', length: 255, nullable: true)]
